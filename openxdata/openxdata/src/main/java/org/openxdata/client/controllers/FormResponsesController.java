...
public class FormResponsesController  extends Controller {
    ...
    public FormDataBinding getFormDataColumnModel(final FormDef formDef) {
        ...
        org.openxdata.sharedlib.client.model.FormDef purcFormDef = XformParser.fromXform2FormDef(formDef.getDefaultVersion().getXform());
    ...
    public void saveFormDataResponse(final User user, final Record record, final FormDef formDef, org.openxdata.sharedlib.client.model.FormDef purcFormDef) {
        ProgressIndicator.showProgressBar(); 

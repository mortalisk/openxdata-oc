...
public class FormDesignerView {
	...
	private void designForm(FormDefVersion formDefVersion, Boolean readOnly) {
        ...
        if (xform != null && xform.trim().length() > 0) {
            ...
            formDesigner.addNewForm(formName + "_" + formVersionName, 
            		getDefaultFormBinding(formDefVersion), formDefVersion.getFormDefVersionId());
        }
	}
    ...
    private void changeDescriptionTemplateValue(Node instanceRoot, String oldName, String newName) {
    ...
    private void changeNodesetOnBindElements(Document xformDocument, String oldName, String newName) {
    ...
    private void replaceInstaceRoot(Document xformDocument, String newName, Node instanceRoot) {

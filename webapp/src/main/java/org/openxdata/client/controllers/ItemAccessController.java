...
public interface ItemAccessController<M extends ModelData> {
	 ...
	 */
	public void addMapping(List<M> itemsToAdd, final ItemAccessListField<M> itemAccessListField);
	 ...
	 * @param itemAccessListField UI component used for callback updates
	 */
	public void deleteMapping(List<M> itemsToDelete, final ItemAccessListField<M> itemAccessListField);

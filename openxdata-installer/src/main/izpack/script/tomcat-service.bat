...
if exist "%CATALINA_HOME%\bin\tomcat6.exe" set EXECUTABLE=%CATALINA_HOME%\bin\tomcat6.exe
if exist "%CATALINA_HOME%\bin\tomcat5.exe" set EXECUTABLE=%CATALINA_HOME%\bin\tomcat5.exe

rem Set default Service name
set SERVICE_NAME=openXtomcat6
set PR_DISPLAYNAME=OpenXData Apache Tomcat 6

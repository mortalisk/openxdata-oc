...
/**
 * Represents and executes BPEL &lt;empty&gt; tags.
 * 
...
class Empty extends Activity
{
	 ...
	 * Creates a new Empty.
	 * 
	 * @param parser the parser to read the empty's attributes
	 ...
	 */
	Empty(XmlPullParser parser, ScopeData scopeData)
		throws XmlPullParserException, IOException, MalformedDocumentException
	{
		super(parser, scopeData, "empty");
		parseStartTag();
		...
		// Nothing besides the standard stuff here . . .
	}

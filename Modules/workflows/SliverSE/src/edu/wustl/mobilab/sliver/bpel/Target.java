...
/**
 * Represents BPEL &lt;target&gt; tags.
 * 
 * @author Greg Hackmann
 */
class Target extends LinkEndpoint
{
	/**
	 * Creates a new Target.
	 * 
	 * @param parser the parser to read the target's attributes from
	 * @param activity the {@link Activity} that acts as the link's target
	 * 
	 ...
	 */	
	Target(XmlPullParser parser, Activity activity) throws IOException,
		XmlPullParserException, MalformedDocumentException
	{
		super(parser, "target", activity);

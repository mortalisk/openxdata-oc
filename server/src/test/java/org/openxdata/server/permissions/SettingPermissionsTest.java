...
public class SettingPermissionsTest extends PermissionsTest {
    ...
    public void saveSettingGroup_shouldThrowOpenXDataSecurityException() throws OpenXDataException {
    	settingService.saveSettingGroup(new SettingGroup());
    }
    
    @Test(expected=OpenXDataSecurityException.class)
    public void saveSettings_shouldThrowOpenXDataSecurityException() throws OpenXDataException {
    	settingService.saveSetting(new Setting());
    }
    
    @Test(expected=OpenXDataSecurityException.class)
    public void deleteSettingGroup_shouldThrowOpenXDataSecurityException() throws OpenXDataException {
    	settingService.deleteSettingGroup(new SettingGroup());
    }
    
    @Test(expected=OpenXDataSecurityException.class)
    public void deleteSetting_shouldThrowOpenXDataSecurityException() throws OpenXDataException {

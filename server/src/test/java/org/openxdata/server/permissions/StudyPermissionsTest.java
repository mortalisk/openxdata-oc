...
public class StudyPermissionsTest extends PermissionsTest {
	...
	public void getStudies_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		studyManagerService.getStudies();
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void saveStudy_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		studyManagerService.saveStudy(new StudyDef());
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void deleteStudy_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {

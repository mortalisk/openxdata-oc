...
public class ReportPermissionsTest extends PermissionsTest {
	...
	public void getReports_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		reportService.getReports();
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void saveReport_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		reportService.saveReport(new Report());
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void saveReportGroup_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		reportService.saveReportGroup(new ReportGroup());
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void deleteReportGroup_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {
		reportService.deleteReportGroup(new ReportGroup());
	}

	@Test(expected = OpenXDataSecurityException.class)
	public void deleteReport_shouldThrowOpenXDataSecurityException()
			throws OpenXDataException {

...
abstract class BaseDAOImpl<T extends Editable> extends GenericDAOImpl<T, Long> implements BaseDAO<T> {
	 ...
	 */
	public Search getSearchFromLoadConfig(Class<? extends AbstractEditable> entityClass, PagingLoadConfig loadConfig, String defaultSortField) {
	...
	public PagingLoadResult<T> getPagingLoadResult(PagingLoadConfig loadConfig, SearchResult<T> searchResult) {
